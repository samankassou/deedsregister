<form class="bg-white shadow-md rounded px-8 pt-6 pb-8 flex flex-col">
    ...
    <div class="flex flex-col md:flex-row items-center justify-center md:justify-between">
        <button type="submit" wire:click.prevent="login" class="bg-yellow-700 w-full md:w-max hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded" type="button">
            Se connecter
        </button>
